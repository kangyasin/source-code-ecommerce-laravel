      ...
      <tr>
        <td class="content-cell">
          ...
          <table class="berhasil" align="center" width="100%" cellpadding="0" cellspacing="0" style="margin-top:30px; margin-bottom:30px;">
            <tr>
              <td align="center">
                <h1 class="berhasil_heading">Konfirmasi Pengiriman</h1>
                <p class="berhasil_body">{{strtoupper($transaksi->kurir)}} - {{$transaksi->kurirpaket}} <br/> Nomor Resi : {{$transaksi->noresi}}</p>
              </td>
            </tr>
          </table>

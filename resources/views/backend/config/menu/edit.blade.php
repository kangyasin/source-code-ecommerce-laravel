...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="box box-warning">
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <form action="/administrator/updatemenu/{{ $datamenu->id }}" method="post" enctype="multipart/form-data" role="form">
              <!-- text input -->
              {{ csrf_field() }}
              ...
              <input type="hidden" name="parent_number" value="0" value="{{ $datamenu->parent_number }}">
              <input type="hidden" name="menulevel" value="1" value="{{ $datamenu->menu_level }}">
              <div class="form-group">
                <label>Publish</label>
                <?php

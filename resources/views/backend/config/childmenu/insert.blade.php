    ...
    <section class="content">
      <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Child Menu Baru</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <form action="/administrator/insertmenuchild/{{Request::segment(3)}}" method="post" enctype="multipart/form-data" role="form">
              <!-- text input -->
              {{ csrf_field() }}
              ...
              <input type="hidden" name="parent_number" value="{{Request::segment(3)}}">
